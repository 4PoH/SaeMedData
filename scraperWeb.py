...
# #Parcours Publi Obsv
# for i in range(2, sheet3.max_row): #pour accelerer suite à un crash changer sheet3.max_row pour la derniere ligne effectuer
...
#Parcours Publi Rand
for i in range(2, sheet4.max_row): #pour accelerer suite à un crash changer sheet4.max_row pour la derniere ligne effectuer
